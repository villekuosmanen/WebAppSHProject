...
class StartView extends Component {
    ...
    render() {
        return (
            <div>
                <div>
                    You are being invited to participate in a research study titled Improving explainability in user-facing
                    recommendation systems. This study is being done by Ville Kuosmanen and (Supervisor) Dr David
                    Harris-Birtill from the School of Computer Science at the University of St Andrews.
                </div>
                <div>We invite you to participate in a research project where you will be asked to rate movie
                ...
                <div>
                    <span>Allow films that are rated "18" or "R18"</span>
